...
public class RemoteAuthTest {
  ...
  @RegisterExtension
  static LoginServerExtension loginServer = new LoginServerExtension();
  ...
  public void noAuthSentTest() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/noAuth")).andExpect(MockMvcResultMatchers.status().isOk());

    // secured endpoint
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")).andExpect(MockMvcResultMatchers.status().isForbidden());
  }
  ...
  public void securedBasicAuthTest() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                "Basic " + HttpHeaders.encodeBasicAuth(USER.getLoggedUser().getUserName(),
                    USER.getPassword(), StandardCharsets.UTF_8)))
        .andExpect(MockMvcResultMatchers.status().isForbidden());

    // user with permissions
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                "Basic " + HttpHeaders.encodeBasicAuth(ADMIN_USER.getLoggedUser().getUserName(),
                    ADMIN_USER.getPassword(), StandardCharsets.UTF_8)))
        .andExpect(MockMvcResultMatchers.status().isOk());

    // invalid user
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                "Basic " + HttpHeaders.encodeBasicAuth(INVALID_USER.getLoggedUser().getUserName(),
                    INVALID_USER.getPassword(), StandardCharsets.UTF_8)))
  ...
  public void securedJwtTest() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                "Bearer " + ADMIN_USER.getJwtToken()))
        .andExpect(MockMvcResultMatchers.status().isOk());

    // invalid user
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                "Bearer " + INVALID_USER.getJwtToken()))
        .andExpect(MockMvcResultMatchers.status().isUnauthorized());
  }
  ...
  public void securedGbifAppTest() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                ADMIN_USER.getGbifSchemeHeader())
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/admin")
            .header(HttpHeaders.AUTHORIZATION,
                INVALID_USER.getGbifSchemeHeader())
  ...
  static class ContextInitializer
    ...
    public void initialize(ConfigurableApplicationContext configurableApplicationContext) {
      TestPropertyValues.of(
              "login.url=" + loginServer.getWireMockServer().baseUrl())
