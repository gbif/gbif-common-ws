 ...
 */
public abstract class BaseWsSuggestClient<T, P extends Enum<?> & SearchParameter,
  R extends FacetedSearchRequest<P>, RSUG extends SearchRequest<P>>
  extends BaseWsFacetedSearchClient<T, P, R> implements SuggestService<T, P, RSUG> {

  private final GenericType<List<T>> suggestType;
  ...
  protected BaseWsSuggestClient(WebResource resource, GenericType<SearchResponse<T, P>> searchType,
    GenericType<List<T>> suggestType) {
